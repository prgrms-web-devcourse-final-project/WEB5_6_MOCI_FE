...
function Page() {
  ...
  return (
    <>
      ...
      <main
        ref={wrapperRef}
        className="relative max-h-dvh pt-12 flex flex-col flex-1 min-h-0"
        style={{ height: containerHeight }}
      >
        <div className="h-20 p-3 flex-center absolute top-12 left-0 right-0 shrink-0">
          ...
          <>
            ...
            <p className="absolute -top-11.5 right-1 p-2 bg-yellow-hover text-xl rounded-lg font-bold hidden peer-hover:block peer-active:block">
